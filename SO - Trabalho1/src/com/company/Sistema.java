...
public class Sistema {
	...
	public class ControleMemoria {
		...
		public void Desaloca_Frames(Progs nomePrograma){
			for (Frame frame : frames) {
				if (frame.nomeProg.equals(nomePrograma) && frame.idProg == (getNextId(nomePrograma) - 1)) {
					ResetFrames(frame);
				}
			}
		}
	...
	//FASE 4 (START)
	//TODO DOING fazer o menu de opcoes que vai levar as funcionalidades requeridas
